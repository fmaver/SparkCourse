...
# To run on EMR succesfully + output results for Star Wars:
# aws s3 cp s3://sundog-spark/MovieSimilarities1M.py ./
# aws s3 cp s3://sundog-spark/ml-1m/ratings.dat ./
...
# we leave it blank bc we´re passing it in the command line when we run the script 
conf = SparkConf()
